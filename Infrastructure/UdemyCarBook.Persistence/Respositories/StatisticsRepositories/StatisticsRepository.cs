...
namespace UdemyCarBook.Persistence.Respositories.StatisticsRepositories
{
    public class StatisticsRepository : IStatisticsRepository
    {
        ...
        public string GetBrandNameByMaxCar()
        {
            ...
            string brandName = _context.Brands.Where(x => x.BrandID == values.BrandID).Select(x => x.Name).FirstOrDefault();
            return brandName;
        }
        ...
        public string GetCarBrandAndModelByRentPriceDailyMinimum()
        {
            int pricingId = _context.Pricings.Where(x => x.Name == "Günlük").Select(y => y.PricingID).FirstOrDefault();
        ...
        public int GetCarCountByTransmiisonIsAuto()
        {
